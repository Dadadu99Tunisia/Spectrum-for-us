...
export const metadata = {
  title: "Communauté LGBTQIA+ Europe — Spectrum For Us",
  description:
      ...
      <main className="min-h-screen flex flex-col" style={{ background: "#0d0d16" }}>
        ...
        <section className="relative px-6 pt-28 pb-10 overflow-hidden">
          <div
            ...
            style={{ background: "radial-gradient(ellipse, #E0337E40, transparent 70%)" }}
          />
          <div
            className="absolute right-0 top-0 w-[400px] h-[250px] pointer-events-none opacity-20"
            style={{ background: "radial-gradient(ellipse, #1C9C9540, transparent 70%)" }}
          />
          <div
        ...
        <section
          ...
          style={{ background: "rgba(243,234,219,0.02)", minHeight: "680px" }}
        >
          <AnnuaireClient />
        </section>
        ...
        <section className="px-6 py-16 text-center max-w-2xl mx-auto">
          ...
          <a
            ...
            style={{ background: "linear-gradient(135deg, #E0337E, #CF3F7C)", color: "#fff" }}
          >
            Nous contacter →
          </a>
        </section>
