              ...
              <div className="space-y-3">
                <div className="grid grid-cols-2 gap-3">
                  <div>
                    ...
                    <input value={carrier} onChange={e => setCarrier(e.target.value)} placeholder="Colissimo, UPS…"
                      className="w-full bg-white/[0.05] border border-white/[0.10] rounded-xl px-3 py-2 font-hanken text-sm text-[#1A1612] placeholder-[#1A1612]/20 focus:outline-none focus:border-[#a78bfa]/50" />
                  </div>
                  <div>
                ...
                <div className="flex gap-2">
                  ...
                  <button onClick={() => setEditTracking(false)}
                    className="px-4 py-2 rounded-xl border border-white/[0.08] text-[#1A1612]/40 font-hanken text-sm hover:text-[#1A1612] transition-colors">
                    Annuler
                  </button>
                </div>
              </div>
