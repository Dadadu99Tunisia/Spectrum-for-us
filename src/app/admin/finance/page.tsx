    ...
    <div className="space-y-6 max-w-[1200px]">
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
        {kpis.map(k => {
          const Icon = k.icon;
          return (
            <div key={k.label} className="p-5 rounded-2xl border border-[#1A1612]/[0.13] bg-[#1A1612]/[0.07]">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-5">
        {/* Revenue trend */}
        <div className="lg:col-span-2 p-5 rounded-2xl border border-[#1A1612]/[0.13] bg-[#1A1612]/[0.07]">
        ...
        <div className="p-5 rounded-2xl border border-[#1A1612]/[0.13] bg-[#1A1612]/[0.07]">
      ...
      <div className="p-5 rounded-2xl border border-[#1A1612]/[0.13] bg-[#1A1612]/[0.07]">
        ...
        <div className="grid grid-cols-2 md:grid-cols-5 gap-3">
          {Object.entries(data.statusBreakdown).map(([status, d]) => (
            <div key={status} className="p-3 rounded-xl border border-[#1A1612]/[0.12]">
              ...
              return (
                <div key={v.shop_id} className="flex items-center gap-4">
                  ...
                  <div className="flex-1">
                    ...
                    <div className="h-1.5 bg-[#1A1612]/[0.09] rounded-full overflow-hidden">
