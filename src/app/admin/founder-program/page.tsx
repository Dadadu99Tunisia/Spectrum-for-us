    ...
    <div className="space-y-6">
      ...
      {counts && (
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
          ...
          />
          <div className="bg-[#1c1235] border border-[#1A1612]/8 rounded-2xl p-5 flex flex-col justify-between">
      ...
      {loading ? (
        ...
        <div className="bg-[#1c1235] border border-[#1A1612]/8 rounded-2xl overflow-hidden">
          {/* Table header */}
