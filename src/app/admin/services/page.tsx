                ...
                <div className="flex items-center justify-between pt-2 border-t border-[#1A1612]/6">
                  ...
                  <div className="flex gap-1">
                    <button onClick={() => toggleActive(w.id, w.is_active)}
                      className={`p-1.5 rounded-lg border border-transparent transition-colors ${w.is_active ? "text-green-400/60 hover:text-red-400 hover:border-red-400/20" : "text-[#1A1612]/20 hover:text-green-400 hover:border-green-400/20"}`}
