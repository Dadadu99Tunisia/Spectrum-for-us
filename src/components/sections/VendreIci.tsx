  ...
  return (
    <section ref={ref} id="vendre" className="py-24 px-6">
      <div className="max-w-5xl mx-auto">
        <div
          className="relative rounded-3xl border border-[#101014]/10 bg-[#101014]/[0.025] p-8 md:p-14 overflow-hidden transition-all duration-700"
        ...
        >
          ...
          <div className="relative z-10">
            ...
            <h2 className="font-fraunces text-3xl md:text-5xl text-[#101014] leading-tight mb-3">
              {t("vendre_ici.title")}{" "}
              <span className="italic text-[#FF2DA0]">{t("vendre_ici.title_em")}</span>
            </h2>
            <p className="font-hanken text-[#101014]/60 text-lg mb-12 max-w-xl">
              ...
              {ARGS.map((arg, i) => {
                ...
                return (
                  ...
                  >
                    ...
                    <div>
                      <h3 className="font-bricolage font-semibold text-[#101014] text-base mb-1">
                        {arg.title}
                      </h3>
