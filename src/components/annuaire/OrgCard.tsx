      ...
      <div className={compact ? "p-3" : "p-4"}>
        ...
        <div className="flex items-start gap-3">
          ...
          <div className="flex-1 min-w-0">
            <h3 className="font-bricolage font-bold text-[#101014] leading-tight truncate"
              style={{ fontSize: compact ? 13 : 15 }}>
              {org.shortName ?? org.name}
            </h3>
            <div className="flex items-center gap-1.5 mt-0.5">
              <span className="text-xs" aria-hidden>{org.flag}</span>
              <span className="font-mono text-[10px] text-[#101014]/35 truncate">
                {org.city}{!compact && `, ${org.country}`}
              </span>
              {org.founded && !compact && (
                <span className="flex items-center gap-0.5 font-mono text-[9px] text-[#101014]/20 ml-auto shrink-0">
                  <Calendar size={8} />
                  {org.founded}
                </span>
              )}
          ...
          {org.website && (
            <a
              ...
              className="shrink-0 opacity-0 group-hover:opacity-100 transition-opacity p-1 rounded-lg hover:bg-[#101014]/8"
        ...
        {(selected || !compact) && (
          <p className="font-hanken text-xs text-[#101014]/50 leading-relaxed mt-2.5 line-clamp-2">
            {org.description}
          </p>
        )}
