...
interface InclusiveSubCategoryPageProps {
  params: {
    id: string
    subId: string
  }
...
export default function InclusiveSubCategoryPage({ params }: InclusiveSubCategoryPageProps) {
  ...
  // Filtrer les produits inclusifs par sous-catégorie
  const inclusiveProducts = products.filter(
    (product) =>
      product.category === params.id && product.subcategory === params.subId && product.tags?.includes("inclusive"),
  )
    ...
    <div className="min-h-screen bg-gradient-to-br from-purple-50 via-pink-50 to-orange-50">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          <div className="text-center">
            ...
            <div className="flex items-center justify-center space-x-2 text-sm text-gray-500 mb-2">
              ...
              <span>/</span>
              <span className="text-purple-600">Inclusif</span>
            </div>
            ...
            <h1 className="text-4xl font-bold bg-gradient-to-r from-purple-600 via-pink-600 to-orange-600 bg-clip-text text-transparent">
              {subcategory.name} Inclusif
            </h1>
            <p className="mt-4 text-lg text-gray-600 max-w-2xl mx-auto">
              Découvrez notre sélection de {subcategory.name.toLowerCase()} conçus pour célébrer la diversité et
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="bg-gradient-to-r from-purple-500 via-pink-500 to-orange-500 rounded-2xl p-8 mb-8 text-white text-center">
          <h2 className="text-2xl font-bold mb-2">🏳️‍🌈 Collection {subcategory.name} Inclusive</h2>
          <p className="text-purple-100">
            {subcategory.name} créés par et pour la communauté LGBTQ+. Chaque achat soutient des créateurs queer.
          </p>
        </div>
            ...
            {inclusiveProducts.length === 0 && (
              <div className="text-center py-12">
                ...
                <p className="text-gray-500 text-lg">
                  Aucun produit inclusif trouvé dans cette sous-catégorie pour le moment.
                </p>
